    ...
    <div className="state-page-wrapper">
      ...
      <section className="contact-hero">
        <div className="container" data-aos="fade-up">
          <h1 className="text-white display-4 fw-bold mb-0">Cab Service in Warangal</h1>
          <nav className="breadcrumb-navbar" aria-label="breadcrumb">
            <ul className="breadcrumb">
              <li className="breadcrumb-item"><Link to="/">Home</Link></li>
              <li className="breadcrumb-item active" aria-current="page">Warangal</li>
            </ul>
          </nav>
        </div>
      </section>
          ...
          <div className="row align-items-center g-lg-5 g-4">
            <div className="col-lg-12" data-aos="fade-left">
              <div className="spotlight-content ps-lg-4">
                <h2 className="mb-3 display-6 fw-bold">Why GK Cabs is <span className="text-primary text-gradient">Warangal's Preferred Choice</span></h2>
                <p className="text-muted mb-4">
                  Warangal, the vibrant capital of Telangana, is a mesmerizing blend of rich history and futuristic innovation. Known for its iconic Charminar, bustling bazaars, and burgeoning IT sector, Hyderabad attracts millions of visitors every year.
                </p>
      ...
      {/* ── Popular Routes from Warangal Section ── */}
      <section className="districts-section section-b-space">
        <div className="container">
          <div className="title mb-5">
            <h3>Popular Routes of States</h3>
